...
<style>
    ...
    th {
        background-color: #000000; /* Чёрный цвет фона заголовков */
        color: #ffffff; /* Белый цвет текста заголовков */
    }

    /* Стиль для четных строк таблицы */
    tr:nth-child(even) {
        background-color: #f2f2f2; /* Чёрный цвет фона для четных строк */
    }

    /* Стиль для кнопок "Редактировать" и "Удалить" */
    .btn-outline-success {
        color: #5bc0de; /* Цвет текста */
        border-color: #5bc0de; /* Цвет рамки */
    }

    .btn-outline-danger {
        color: #d9534f; /* Цвет текста */
        border-color: #d9534f; /* Цвет рамки */
    }
</style>
